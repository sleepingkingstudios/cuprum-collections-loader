...
RSpec.describe Cuprum::Collections::Loader::Upsert do
  ...
  describe '#call' do
    shared_examples 'should find and update or create the entity' do
      context 'when no matching entity exists' do
        ...
        describe 'with a valid attributes Hash' do
          ...
          let(:expected_value) { ['create', attributes] }
      ...
      context 'when a matching entity exists' do
        ...
        describe 'with a valid attributes Hash' do
          let(:attributes)          { super().merge(valid_attributes) }
          let(:expected_attributes) { matching_entity.merge(attributes) }
          let(:expected_value)      { ['update', expected_attributes] }
    ...
    context 'when initialized with attribute_names: value' do
      ...
      context 'when there are multiple matching entities' do # rubocop:disable RSpec/MultipleMemoizedHelpers
